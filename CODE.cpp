...
inline void title(){
    clrscr();
	cout<<"======================================================================================="<<endl;
	cout<<"******************* GRAPHIC ERA Student Database Management System ********************"<<endl;
	cout<<"======================================================================================="<<endl;
}
...
int ADMIN::complaint(){
	...
	char ch;
	cout<<"\n\tCOMPLAINT:\n\n";
    ifstream readfile1("complaint.txt",ios::binary|ios::in);
...
//administrator acces to change the attendence
...
void STUDENT::showMarks(){
    ...
    cout<<" Computer Organization & architecture  | ";  (marks.co>=0)?cout<<marks.co<<endl:cout<<"Not Entered"<<endl;
...
int STAFF::manageMarks(){
	...
	//write back the changes made to the attendence.
